...
import { toJsonApiErrors } from '../src/formatters/json-api'
...
describe('toJsonApiErrors', () => {
  ...
  test('should sanitize errors globally', () => {
    const result = toJsonApiErrors(err1, { sanitize: true })
